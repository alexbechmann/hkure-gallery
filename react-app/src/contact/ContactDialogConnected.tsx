...
import { sendMessage, closeContactDialog } from 'contact/state/contact.actions';
...
const mapDispatchToProps: ContactDialogDispatchProps = { sendMessage, closeContactDialog };
